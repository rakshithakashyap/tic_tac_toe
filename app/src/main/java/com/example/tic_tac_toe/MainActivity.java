...
public class MainActivity extends AppCompatActivity {
    ...
    private String startGame="X" , pname1 , pname2;

    int b1=5,b2=5,b3=5,b4=5,b5=5,b6=5,b7=5,b8=5,b9=5,xCount=0,oCount=0,i=0;
    int c1=0,c2=0,c3=0,c4=0,c5=0,c6=0,c7=0,c8=0,c9=0;
    private TextView scorex,scoreo;
    private Button Reset , endgame  ;

    //Xcount - to get the current score
    // ocount - to get the total score
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

         pname1 = getIntent().getStringExtra("pname1");
         pname2 = getIntent().getStringExtra("pname2");
        ...
        scorex.setText(pname1 +" :- 0");
        scoreo.setText(pname2 +" :- 0");
        ...
        Reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                xCount=0;
                oCount=0;
                scorex.setText(pname1+" :- "+String.valueOf(xCount));
                scoreo.setText(pname2+" :- "+String.valueOf(oCount));
            }
        });
    ...
    private void winningGame() {
        ...
        if((b1==1) && (b2==1) && (b3==1))
        {
            ...
            builder.setMessage(pname1+" Wins").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
        ...
        else  if((b1==0) && (b2==0) && (b3==0))
        {
            ...
            AlertDialog.Builder builder=new AlertDialog.Builder(this);
            builder.setMessage(pname2+" Wins").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
